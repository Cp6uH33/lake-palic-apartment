...
const translations = {
  ...
  hu: {
    ...
    form_error: "Hiba történt. Kérjük, próbálja újra.",
    ...
    <nav className={`fixed top-0 left-0 w-full z-50 transition-all duration-300 ${scrolled ? 'bg-[#2B2118]/80 backdrop-blur-md shadow-lg py-4' : 'bg-transparent py-6'}`}>
      <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
        <div className="flex items-center gap-4 sm:gap-8 group">
          <img
            src="/logo.webp"
            alt="Lake Palić Apartment,Apartman Rakanovic Logo"
            width={80}
            height={80}
        ...
        <div className="flex items-center gap-4 sm:gap-6">
          <a href="#smestaj" className="text-slate-200 hover:text-[#fffeeb] font-medium text-sm transition hidden md:block">
            {t.nav_apartments}
          </a>
          <a
            href="#rezervacija"
            className="bg-transparent hover:bg-[#FFD700]/20 text-white px-5 sm:px-6 py-2 sm:py-2.5 rounded-full font-bold text-sm transition-all shadow-md hidden sm:block border-2 border-[#FFD700]"
          >
            {t.nav_contact}
          </a>
          ...
          <div className="flex items-center gap-2 bg-slate-800/50 backdrop-blur-sm rounded-full p-1 border border-white/10 shadow-inner">
            ...
            >
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 3 2" className="w-full h-full object-cover">
                ...
                <rect width="3" height="1.333" y="0.667" fill="#0c4076" />
            ...
            >
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 3 2" className="w-full h-full object-cover">
                ...
                <rect width="3" height="0.667" fill="#CD2A3E" />
              </svg>
            </button>
          </div>
        </div>
              ...
              <Swiper modules={[Navigation, Pagination]} navigation pagination={{ clickable: true }} loop className="w-full h-full">
                <SwiperSlide>
                  <img
                    ...
                    height={600}
                    className="w-full h-full object-cover"
                    alt="Dnevna soba apartmana Rakanović blizu jezera Palić"
                  />
                </SwiperSlide>
                <SwiperSlide>
                  <img
                ...
                <SwiperSlide>
                  <img
                    ...
                    height={600}
                    className="w-full h-full object-cover"
                    alt="Spavaća soba apartmana Rakanović blizu jezera Palić"
                  />
                </SwiperSlide>
                <SwiperSlide>
                  <img
                ...
                <SwiperSlide>
                  <img
                    ...
                    height={600}
                    className="w-full h-full object-cover"
                    alt="Kuhinja apartmana Rakanović blizu jezera Palić"
                  />
                </SwiperSlide>
                <SwiperSlide>
                  <img
  ...
  const getPlaces = () => {
    if (lang === 'en') {
      return [
        {
          name: 'Lake Palić',
          desc: 'Symbol of the region, ideal for long walks and relaxation.',
          fullDesc:
            'Lake Palić is the largest natural lake in Serbia and a true oasis of peace. Surrounded by beautiful promenades, old luxury villas from the Art Nouveau period, and century-old parks.',
          location: 'Lajos Vermes Coast, Palić',
          tag: 'Nature',
          image: '/mesto1.webp'
        },
        {
          name: 'Palić Zoo',
          desc: 'Beautiful park with rich flora and fauna, perfect for families.',
          fullDesc: 'Not just an ordinary zoo, but a beautiful botanical park with over 270 species of trees and shrubs.',
          location: 'Krfska 4, Palić',
          tag: 'Family',
          image: '/mesto2.webp'
        },
        {
          name: 'Zvonko Bogdan Winery',
          desc: 'Enjoy premium wines and beautiful architecture.',
          fullDesc:
            'Located just a few hundred meters from the lake, it represents a blend of modern technology and traditional architecture in the Art Nouveau style.',
        ...
        {
          name: 'City Hall',
          desc: 'Masterpiece of Hungarian Art Nouveau in the center of Subotica.',
          fullDesc:
            'Symbol of Subotica and one of the most significant architectural works in the region. Built in the early 20th century, richly decorated with Zsolnay ceramics.',
          location: 'Trg Slobode 1, Subotica',
          tag: 'Architecture',
          image: '/mesto4.webp'
        },
        {
          name: 'Synagogue',
          desc: 'One of the most beautiful and largest buildings of this type in Europe.',
          fullDesc:
            'Subotica Synagogue, built in 1902, is the second largest in Europe. Its interior takes your breath away – painted with floral motifs.',
        ...
        {
          name: 'Raichle Palace',
          desc: 'A building of surreal beauty that looks like it came from a fairy tale.',
          fullDesc:
            'Raichle Palace is probably the most photographed building in Subotica. Architect Ferenc Raichle built it as his home and architectural office.',
          location: 'Park Rajhl Ferenca 5, Subotica',
          tag: 'Art',
          image: '/mesto6.webp'
        }
      ];
      ...
      return [
        {
          name: 'Palicsi-tó',
          desc: 'A régió szimbóluma, ideális hosszú sétákra és pihenésre.',
          fullDesc:
            'A Palicsi-tó Szerbia legnagyobb természetes tava és a béke igazi oázisa. Gyönyörű sétányok, szecessziós luxusvillák és évszázados parkok veszik körül.',
          location: 'Lajos Vermes part, Palics',
          tag: 'Természet',
          image: '/mesto1.webp'
        },
        {
          name: 'Palicsi Állatkert',
          desc: 'Gyönyörű park gazdag növény- és állatvilággal, tökéletes családoknak.',
          fullDesc:
            'Nem csak egy hétköznapi állatkert, hanem egy gyönyörű botanikus kert több mint 270 fafajjal.',
          location: 'Korfu utca 4, Palics',
          tag: 'Család',
          image: '/mesto2.webp'
        },
        {
          name: 'Zvonko Bogdan Pincészet',
          desc: 'Élvezze a prémium borokat és a gyönyörű építészetet.',
          fullDesc:
            'Alig néhány száz méterre a tótól, a modern technológia és a hagyományos szecessziós építészet ötvözete.',
          location: 'Kanizsai út 45, Palics',
          tag: 'Gasztronómia',
          image: '/mesto3.webp'
        },
        {
          name: 'Városháza',
          desc: 'A magyar szecesszió remekműve Szabadka központjában.',
          fullDesc:
            'Szabadka szimbóluma és a régió egyik legjelentősebb építészeti alkotása. A 20. század elején épült, Zsolnay kerámiával gazdagon díszítve.',
          location: 'Szabadság tér 1, Szabadka',
          tag: 'Építészet',
          image: '/mesto4.webp'
        },
        {
          name: 'Zsinagóga',
          desc: 'Európa egyik legszebb és legnagyobb ilyen típusú épülete.',
          fullDesc:
            'Az 1902-ben épült szabadkai zsinagóga Európa második legnagyobbja. Belseje lélegzetelállító – virágmotívumokkal festve.',
          location: 'Jakab és Komor tér 6, Szabadka',
          tag: 'Kultúra',
          image: '/mesto5.webp'
        },
        {
          name: 'Raichle-palota',
          desc: 'Szürreális szépségű épület, amely mintha egy meséből lépett volna elő.',
          fullDesc:
            'A Raichle-palota talán a legtöbbet fényképezett épület Szabadkán. Raichle Ferenc építész saját otthonaként és irodájaként építette.',
          location: 'Raichle Ferenc park 5, Szabadka',
          tag: 'Művészet',
          image: '/mesto6.webp'
        }
      ];
    ...
    return [
      {
        name: 'Palićko Jezero',
        desc: 'Simbol regiona, idealno za duge šetnje, vožnju biciklom i potpuno opuštanje pored vode.',
        fullDesc:
          'Palićko jezero je najveće prirodno jezero u Srbiji i prava oaza mira. Okruženo je prelepim šetalištima, starim luksuznim vilama iz perioda secesije i stoletnim parkovima.',
        location: 'Obala Lajoša Vermeša, Palić',
        tag: 'Priroda',
        image: '/mesto1.webp'
      },
      {
        name: 'Zoološki Vrt Palić',
        desc: 'Prelep park sa bogatom florom i faunom, savršen za porodični izlet i decu svih uzrasta.',
        fullDesc:
          'Zoološki vrt na Paliću nije običan zoološki vrt – on je ujedno i prelep botanički park sa preko 270 vrsta drveća i žbunja.',
        location: 'Krfska 4, Palić',
        tag: 'Porodica',
        image: '/mesto2.webp'
      },
      {
        ...
        desc: 'Uživajte u vrhunskim vinima i prelepoj arhitekturi inspirisanoj tradicionalnim panonskim stilom.',
        fullDesc:
          'Smeštena na samo nekoliko stotina metara od jezera, Vinarija Zvonko Bogdan predstavlja spoj najmodernije tehnologije i tradicionalne arhitekture u stilu secesije.',
        location: 'Kanjiški put 45, Palić',
        tag: 'Gastronomija',
        image: '/mesto3.webp'
      },
      {
        name: 'Gradska Kuća',
        desc: 'Remek-delo mađarske secesije u samom centru Subotice sa prelepim vidikovcem na vrhu.',
        fullDesc:
          'Simbol Subotice i jedno od najznačajnijih arhitektonskih dela u regionu. Sagrađena početkom 20. veka, bogato je ukrašena Žolnai keramikom, vitražima i drvoredima.',
        location: 'Trg Slobode 1, Subotica',
        tag: 'Arhitektura',
        image: '/mesto4.webp'
      },
      {
        name: 'Sinagoga',
        desc: 'Jedna od najlepših i najvećih građevina ovog tipa u Evropi, nedavno potpuno restaurirana.',
        fullDesc:
          'Subotička Sinagoga, izgrađena 1902. godine, druga je po veličini u Evropi. Njena unutrašnjost oduzima dah – obojena je floralnim motivima u stilu mađarske secesije.',
        location: 'Trg Jakaba i Komora 6, Subotica',
        tag: 'Kultura',
        image: '/mesto5.webp'
      },
      {
        name: 'Palata Rajhl',
        desc: 'Zgrada nestvarne lepote koja izgleda kao iz bajke, danas dom Savremene galerije Subotice.',
        fullDesc:
          'Palata Rajhl je verovatno najfotografisanija zgrada u Subotici. Izgradio ju je arhitekta Ferenc Rajhl kao svoj dom i arhitektonski biro.',
        location: 'Park Rajhl Ferenca 5, Subotica',
        tag: 'Umetnost',
        image: '/mesto6.webp'
      }
    ...
    <section className="bg-[#FFFDD0] py-24 px-6 relative">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <div className="w-24 h-1 bg-[#2B2118] mx-auto rounded-full mb-6" />
        </div>
          ...
          {places.map((place, index) => (
            ...
            >
              ...
              <div className="p-6 flex-1 flex flex-col">
                <h3 className="font-bold font-serif text-2xl text-[#2B2118] mb-3 group-hover:text-[#2B2118]/50 transition-colors">
                  {place.name}
                </h3>
                <p className="text-[#2B2118] text-sm leading-relaxed mb-4 flex-1">{place.desc}</p>
                <div className="mt-auto pt-4 border-t border-slate-100 flex items-center text-[#2B2118] text-sm font-semibold group-hover:gap-2 transition-all">
                  {t.guide_btn} <span className="ml-1 transition-transform duration-300 group-hover:translate-x-1">→</span>
                </div>
              </div>
            </div>
          ))}
          ...
          <div className="bg-[#fffeeb] w-full max-w-3xl rounded-3xl overflow-hidden shadow-2xl relative flex flex-col max-h-[90vh]">
            ...
            <div className="h-64 sm:h-80 w-full relative shrink-0">
              ...
              <div className="absolute bottom-6 left-6 md:left-10 text-white">
                <span className="text-xs font-bold text-[#2B2118] bg-[#FFD700] px-3 py-1 rounded-full uppercase tracking-wider mb-3 inline-block">
                  {selectedPlace.tag}
                </span>
            ...
            <div className="p-6 md:p-10 overflow-y-auto">
              <div className="flex items-center text-[#2B2118] font-medium mb-6 bg-[#fffeeb] p-4 rounded-xl border border-[#FFD700]">
                <MapPin className="w-5 h-5 text-[#2B2118] mr-3" />
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="ml-auto text-sm text-[#2B2118] hover:underline font-semibold"
                >
                  {t.guide_modal_map}
                </a>
              </div>
      ...
      return [
        {
          ...
          a: 'Payment is made upon arrival in cash, or in advance via bank transfer. We are introducing card payments soon.'
        },
        {
          q: 'Can I cancel or change my reservation?',
          a: 'Yes, you can cancel your reservation for free up to 7 days before your planned arrival. After that period, we retain the deposit.'
        },
        {
          q: 'What is the check-in and check-out time?',
          a: 'Check-in is possible from 14:00h, while check-out is strictly by 10:00h on the day of departure.'
        },
        {
          q: 'Is there parking available for guests?',
          a: 'Absolutely. Each apartment has a guaranteed, free, and secure parking space in the courtyard.'
        },
        {
          q: 'Do the apartments have Wi-Fi and air conditioning?',
          a: 'All our apartments are equipped with fast optical internet and modern air conditioning units without extra charge.'
        },
        {
          q: 'Are bed linen and towels provided?',
          a: 'Yes, clean bed linen, towels, and basic cosmetics (shampoo, soap) will be waiting for you in the apartment.'
        }
      ];
    } else if (lang === 'hu') {
      return [
        {
          ...
          a: 'A fizetés érkezéskor készpénzben történik, vagy előre banki átutalással. Hamarosan bevezetjük a kártyás fizetést is.'
        },
        {
          q: 'Módosíthatom vagy lemondhatom a foglalást?',
          a: 'Igen, a foglalás ingyenesen lemondható az érkezés előtt 7 nappal. Ezen időszak után a foglalót megtartjuk.'
        },
        {
          q: 'Mikor van a bejelentkezés (check-in) és a kijelentkezés (check-out)?',
          a: 'A bejelentkezés 14:00 órától lehetséges, míg a kijelentkezés az indulás napján legkésőbb 10:00 óráig történik.'
        },
        {
          q: 'Van parkolási lehetőség a vendégek számára?',
          a: 'Abszolút. Minden apartmanhoz biztosított, ingyenes és biztonságos parkolóhely tartozik az udvarban.'
        },
        {
          q: 'Van az apartmanokban Wi-Fi és légkondicionáló?',
          a: 'Minden apartmanunk gyors optikai internettel és modern légkondicionálókkal van felszerelve, felár nélkül.'
        },
        {
          q: 'Biztosítanak ágyneműt és törölközőt?',
          a: 'Igen, tiszta ágynemű, törölközők és alapvető kozmetikumok (sampon, szappan) várják Önt az apartmanban.'
        }
      ];
    }
    return [
      {
        ...
        a: 'Plaćanje se vrši prilikom dolaska u apartman u gotovini, ili unapred uplatom na tekući račun. Uskoro uvodimo i plaćanje karticama.'
      },
      {
        q: 'Da li je moguće otkazati ili promeniti rezervaciju?',
        a: 'Da, rezervaciju je moguće besplatno otkazati do 7 dana pre planiranog dolaska. Nakon tog perioda zadržavamo depozit.'
      },
      {
        q: 'Koje je vreme prijave (check-in) i odjave (check-out)?',
        a: 'Prijavljivanje u apartman je moguće od 14:00h, dok je odjavljivanje najkasnije do 10:00h ujutru na dan odlaska.'
      },
      {
        q: 'Da li je obezbeđen parking za goste?',
        a: 'Apsolutno. Svaki apartman ima obezbeđeno, besplatno i sigurno parking mesto u dvorištu objekta.'
      },
      {
        q: 'Da li apartmani imaju Wi-Fi i klimu?',
        a: 'Svi naši apartmani su opremljeni brzim optičkim internetom i modernim klima uređajima bez dodatne doplate.'
      },
      {
        q: 'Da li je posteljina i peškiri obezbeđeni?',
        a: 'Da, čista posteljina, peškiri, kao i osnovna kozmetika (šampon, sapun) vas čekaju u apartmanu.'
      }
    ];
  };
        ...
        <div className="bg-[#fffeeb] p-8 md:p-12 rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.06)] border border-slate-100 min-h-[400px] flex flex-col justify-center">
          {status === 'success' ? (
            <div className="text-center animate-fade-in flex flex-col items-center py-10">
              ...
              <h3 className="text-3xl font-serif font-bold text-[#2B2118] mb-4">{t.form_success_title}</h3>
              <p className="text-[#2B2118]/70 text-lg max-w-md mx-auto">{t.form_success_desc}</p>
              <button
                type="button"
                onClick={() => setStatus('idle')}
                className="mt-8 text-[#2B2118] font-medium hover:text-[#2B2118]/60 transition-colors underline"
              >
                {t.form_success_btn}
              </button>
            </div>
              ...
              >
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    <label htmlFor="ime" className="text-sm font-semibold text-[#2B2118] ml-1">
                      {t.form_name}
                    </label>
                    <input
                      type="text"
                      ...
                      name="ime"
                      required
                      className="w-full bg-[#fffeeb] border border-[#FFD700] rounded-xl px-4 py-3 focus:ring-2 focus:ring-[#FFD700]/40 outline-none"
                    />
                  </div>
                  <div className="space-y-2">
                    <label htmlFor="prezime" className="text-sm font-semibold text-[#2B2118] ml-1">
                      {t.form_surname}
                    </label>
                    <input
                      type="text"
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    <label htmlFor="email" className="text-sm font-semibold text-[#2B2118] ml-1">
                      {t.form_email}
                    </label>
                    <input
                      type="email"
                  ...
                  <div className="space-y-2">
                    <label htmlFor="telefon" className="text-sm font-semibold text-[#2B2118] ml-1">
                      {t.form_phone}
                    </label>
                    <input
                      type="tel"
                ...
                <div className="space-y-2">
                  <label htmlFor="poruka" className="text-sm font-semibold text-[#2B2118] ml-1">
                    {t.form_message}
                  </label>
                  <textarea
                    id="poruka"
                    ...
                    required
                    rows={4}
                    className="w-full bg-[#fffeeb] border border-[#FFD700] rounded-xl px-4 py-3 focus:ring-2 focus:ring-[#FFD700]/40 outline-none resize-none"
                  />
                </div>
                ...
                <div className="pt-4 flex justify-end">
                  <button
                    ...
                    className="group flex items-center bg-[#2B2118] hover:bg-[#fffeeb] border border-[#FFD700] transition-colors duration-300 rounded-full pl-8 pr-2 py-2 shadow-lg disabled:opacity-70"
                  >
                    <span className="font-medium text-[#FFD700] group-hover:text-[#2B2118] mr-4">
                      {status === 'submitting' ? t.form_sending : t.form_btn}
                    </span>
                    <div className="w-10 h-10 bg-[#FFD700] border border-[#FFD700] rounded-full flex items-center justify-center transition-colors">
                      <ArrowUpRight className="w-5 h-5 text-[#2B2118] group-hover:text-slate-900 transition-transform group-hover:rotate-45" />
                    </div>
                  </button>
                </div>
              </form>
    ...
    <div className="fixed bottom-6 left-6 z-[999] flex flex-col items-center gap-3 pointer-events-none">
      ...
      >
        ...
        >
          ...
          <span className="absolute left-full ml-3 px-2 py-1 bg-slate-900 text-white text-xs rounded opacity-0 group-hover:opacity-100 whitespace-nowrap pointer-events-none transition-opacity">
            Viber
          </span>
        </a>
        ...
        {/* WHATSAPP */}
        <a
          href={`https://wa.me/${phoneNumber}?text=Poštovani, zanima me smeštaj u vašem apartmanu.`}
          target="_blank"
          rel="noopener noreferrer"
          className="w-12 h-12 bg-[#25D366] hover:bg-[#128C7E] rounded-full flex items-center justify-center shadow-lg transition-transform hover:scale-110 group relative"
          aria-label="WhatsApp"
        >
...
const Footer = ({ lang }) => {
  ...
  return (
    <footer className="bg-[#282119]/80 text-[#fffeeb] pt-20 pb-10 px-6" id="kontakt">
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-16 mb-16">
        <div>
          <h2 className="text-4xl font-serif font-bold text-[#fffeeb] mb-6">{t.footer_title}</h2>
          <p className="text-[#fffeeb] max-w-md mb-8">{t.form_desc}</p>
          <div className="space-y-4">
            <a
              href="tel:+38162228034"
              className="flex items-center text-lg hover:text-white transition group"
            >
              <span className="w-12 h-12 bg-[#FFD700] rounded-full flex items-center justify-center mr-4 group-hover:bg-[#2B2118] transition">
                <Phone className="w-5 h-5 text-[#2B2118] group-hover:text-[#fffeeb] transition-colors" />
              </span>
              +381 62 228 034
            </a>
            <a
              href="mailto:lakepalicapt@gmail.com"
              className="flex items-center text-lg hover:text-white transition group"
            >
              <span className="w-12 h-12 bg-[#FFD700] rounded-full flex items-center justify-center mr-4 group-hover:bg-[#2B2118] transition">
                <Mail className="w-5 h-5 text-[#2B2118] group-hover:text-[#fffeeb] transition-colors" />
              </span>
              lakepalicapt@gmail.com
            </a>
          </div>
        </div>
        <div className="bg-[#fffeeb] p-8 rounded-3xl flex flex-col justify-center border border-[#FFD700]">
          <h3 className="text-2xl font-bold text-[#2B2118] mb-2">{t.footer_location}</h3>
          <p className="text-[#2B2118] mb-6 flex items-center">
            <MapPin className="w-5 h-5 mr-2" />
            Kanjiški put 17b, Palić, Srbija
          </p>
          <div className="h-56 md:h-64 bg-slate-700 rounded-xl overflow-hidden shadow-inner">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2766.584779375152!2d19.76222137587712!3d46.09925339084416!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x4743617c48e792a7%3A0x7bbd7cfb05637bb7!2sLake%20Pali%C4%87%20Apartment!5e0!3m2!1sen!2srs!4v1772964410305!5m2!1sen!2srs"
              width="100%"
              height="100%"
              style={{ border: 0 }}
              allowFullScreen
      ...
      <div className="max-w-7xl mx-auto border-t border-[#FFD700] pt-8 flex flex-col md:flex-row justify-between items-center text-sm text-[#fffeeb]">
        <p>&copy; {new Date().getFullYear()} Lake Palić Apartments. Sva prava zadržana.</p>
        <div className="flex items-center gap-4 mt-4 md:mt-0">
          <div className="relative group flex items-center justify-center">
            <a
              href="#"
              className="p-2 bg-[#fffeeb] hover:bg-[#2B2118] rounded-full text-[#2B2118] hover:text-white transition-all duration-300"
            >
              <Code2 className="w-4 h-4" />
            </a>
            <div className="absolute bottom-full right-0 mb-3 w-max px-3 py-2 bg-[#FFD700] text-[#2B2118] text-xs font-medium rounded-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 shadow-xl border border-slate-700 pointer-events-none transform translate-y-2 group-hover:translate-y-0 z-50">
              Dizajn i izrada: Ignjatije
              <div className="absolute -bottom-1 right-3.5 w-2 h-2 bg-[#2B2118] border-b border-r border-slate-700 transform rotate-45" />
            </div>
          </div>
        </div>
      </div>
...
export default function App() {
  ...
  return (
    <div className="font-sans text-slate-800 bg-[#FFFDD0] selection:bg-[#FFD700]/30 selection:text-[#2B2118] scroll-smooth">
